...
public class AddTourActivity extends AppCompatActivity {
    ...
    TextInputEditText titleZH, titleEN;
    ...
    public void prepareView()
    {
        ...
        titleZH = findViewById(R.id.titleA);
    ...
    public void addTour(View v) {
        if (AdminPlaceAdapter.chosen_places.size() >= 3) {
            ...
            if (Text_checker()) {
                ...
                mTour = new Tour(makeCategoryChinese(chosen_place), makeCategoryEnglish(chosen_place), comments, 0, images(chosen_place), 0, chosen_place, 0.0, titleZH.getText().toString().trim(), titleEN.getText().toString().trim(), newTourRef.getId(), makeKeywords(chosen_place));
    ...
    private ArrayList<String> makeCategoryChinese(List<Place> mPlaces) {
        ArrayList<String> ar = new ArrayList<>();
        for (int i = 0; i < mPlaces.size(); i++) {
            if (!ar.contains(mPlaces.get(i).categoryZH))
                ar.add(mPlaces.get(i).categoryZH);
        }
        return ar;
    }
    ...
    private boolean Text_checker() {
        if (titleEN.getText().toString().isEmpty() || titleEN.getText().toString().equalsIgnoreCase("")) {
            ...
            return false;
        } else if (titleZH.getText().toString().isEmpty() || titleZH.getText().toString().equalsIgnoreCase("")) {
            titleZH.setError("please add this feild");
            return false;
        }
        return true;
    }
